...
tf.app.flags.DEFINE_string('dataset_dir', '/home/hamid/PycharmProjects/Deep-Mutual-Learning/datasets/results/market-1501/tfrecords',
                           'The directory where the dataset files are stored.')

tf.app.flags.DEFINE_string('checkpoint_dir', 'market1501_dml_normal/checkpoint',
                           'Directory name to save the checkpoints [checkpoint]')

tf.app.flags.DEFINE_string('log_dir', 'market1501_dml_normal/logs',
